export const environment = {
  ...
  keycloak: {
    ...
    checkSessionIframe:
      'http://localhost:8080/realms/my-realm/protocol/openid-connect/login-status-iframe.html',
    revocationEndpoint:
      'http://localhost:8080/realms/my-realm/protocol/openid-connect/revoke',
